    ...
    <section className="mb-32">
        ...
        <div className="flex justify-center">
            <div className="text-center md:max-w-xl lg:max-w-3xl">
                <h1 className="mb-12 px-6 text-5xl font-bold">
                    Contact us
                </h1>
            </div>
        </div>
        ...
        <div className="flex flex-wrap">
            ...
            <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                ...
                <button type="button"
                        className="mb-6 inline-block w-full rounded bg-slate-700 px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-slate-900">
                        Send
                </button>
